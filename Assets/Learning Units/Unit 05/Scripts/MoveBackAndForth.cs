...
public class MoveBackAndForth : MonoBehaviour
{
    ...
    float moveAmount = 0.01f; // I lied, you should change this line!
    ...
    void Start()
    {
        ...
        {
            startPositions.Add(objectToMove.transform.position); // one of these lists needs this kind of position...
            endPositions.Add(objectToMove.transform.position + new Vector3(0,0,10f)); // another one needs another...
        }
    }
